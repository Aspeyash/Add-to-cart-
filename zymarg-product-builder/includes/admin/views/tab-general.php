 ...
 * General tab.
 *
 * Vars: $fields (schema), $values, $current_tab.
 *
...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="zpb-form" data-zpb-form>
	...
	<p class="description">
		<?php esc_html_e( 'Plugin-wide defaults. Individual Elementor widget instances can override anything here.', 'zymarg-product-builder' ); ?>
	</p>
